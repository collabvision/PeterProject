...
import AboutUsContentImage from '../assets/why_chose_us.jpeg';
...
const AboutUs = () => {
  ...
  <div className="container">
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-12" style={{ marginTop: '30px' }}>
                ...
                <p style={{ fontSize: '16px', lineHeight: '1.8', color: '#333' }}>
                  <strong>Innovative Educator:</strong> Known for his creativity, Mr. Lim developed unique teaching aids and gadgets, many of which are used in Singapore schools. His innovative methods have also been shared through workshops and training sessions for science teachers and subject teaching assistants (STAs).
                </p>
                <p style={{ fontSize: '16px', lineHeight: '1.8', color: '#333' }}>
   ...
   <li>Secondary Level Tuition: Physics, Chemistry, Mathematics (A&E), and English.</li>
              ...
              <div className="col-md-6">
                <img src={AboutUsContentImage} alt="Our Offerings" className="img-fluid rounded" style={{ marginTop: "60px", boxShadow: '0 4px 8px rgba(0,0,0,0.1)', width: "90%", height:"380px" }} />
              </div>
            </div>
          </div>
        </section>
