...
import about_us from '../assets/peeter_home.jpeg';
import who_we_are from '../assets/why_choose_usHome.jpeg';
...
>
  <div className="col-6 col-md-3 mb-4 image-container" style={{ margin: '0 20px' }}>
    <img
      src={temp1}
      alt="temp1"
      className="image"
        ...
        <div className="container">
          <div className="row d-flex align-items-center">
            <div className="col-md-6">
              <img src={about_us} alt="About Us" style={{ width: '98%', height:"460px", borderRadius: '5px', boxShadow: '0px 4px 20px rgba(0, 0, 0, 0.2)' }} />
            </div>
            <div className="col-md-6 mt-5">
              <h2 className="slideInLeft wow" style={{ color: "#3F497F" }}>About Us</h2>
              <p style={{textAlign:"left", fontWeight:"400" , color:"black"}}>
                We are committed to providing quality education through innovative programs that cater to the needs of today's learners. Our aim is to empower students with the knowledge and skills they need to succeed and bring back the joy of Studying.
